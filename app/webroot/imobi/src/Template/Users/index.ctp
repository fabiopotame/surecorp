    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('register_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $user->has('register') ? $this->Html->link($user->register->id, ['controller' => 'Registers', 'action' => 'view', $user->register->id]) : '' ?></td>
